...
Then, we can see a pattern. We can split the genotypes into n homozygotes (ex: 11 22) and $n \choose 2$ heterozygotes (ex: 12), such that for n alleles we have, $n + {n \choose 2}$ possible genotypes, where we know ${n \choose 2} = \frac{n(n-1)}{2}$. So, $$n + \frac{n(n-1)}{2} = \frac{2n + n(n-1)}{2} = \frac{2n + n^2 - n}{2} = \frac{n^2 + n}{2} = \frac{n(n+1)}{2}$$.
...
$\mathbb{F} = (1 \times 0.0843) + (1/2 \times 0.3343) + (1/2 \times 0.0452) = 0.2741$ $\mathbb{I} = (1 \times 0.0151) + (1/2 \times 0.0964) + (1/2 \times 0.0452) = 0.0859$
...
|:----------:|:-------------------------------------:|:---------------------:|
|     1      |                 $p_f$                 |         $p_m$         |
|     2      |         $\frac{p_f - p_m}{2}$         |         $p_f$         |
|     3      | $\frac{p_f - p_m}{2} + \frac{p_f}{2}$ | $\frac{p_f - p_m}{2}$ |
